...
<table width="60%" cellspacing="0" cellpadding="0" style="border: #FFCC99 1px solid; font-family:verdana, arial; font-size:12px; font-color:#0033cc">
	<tr>
		<td align="center">
			...
			<p>The square(s) <strong><font color="#ff0000"><?=$selectedSQUARES?></font></strong> is(are) temporary reserved in your name "<font color="#ff0000"><?=$name?></font>", pending confirmation by Nilesh Shukla.</p>
